...
const star = <svg width="1.25rem" height="1.25rem" viewBox="0 0 12 11" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default function Card(props) {
    return (
        <div className = 'card'>
            ...
            <img width = '170px' height = '230px' src= {props.coverImg} alt='of Katie Zaferes'/>
            <div className= 'onlineStatus'>SOLD OUT</div>
            </div>
            <div className = 'cardInfo'>
                <p className = 'cardInfoFirstLine'> {star} 
                {props.stats.rating} <span className = 'locationText'> ({props.stats.reviewCount}) <span className = 'dot'>• </span> {props.country} </span>
                </p>
                <p>
                {props.title}
                </p>
